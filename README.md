...
| **地圖**：底部是原版的指令列，熱鍵字母照原版不跟著翻譯走 | **訊息**：4,914 條可翻字串已全部翻完 |
...
| 中文化 | 可翻字串 4,914／4,914（原版語料 4,806 ＋ 重製版介面 108）、段落書 162／162 |
...
RE 筆記 108 份，每一份都在[接線表](docs/re/00-wiring-status.md)登記
