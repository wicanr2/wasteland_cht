...
1. **翻譯本體** —— 目前 **4,590 / 4,827**。執行檔九張表已翻完（414 條；剩 12 條是
   純控制碼與解碼雜訊，不該翻）；地圖區塊的共用文本（戰鬥動詞、開門訊息）
   走**文本層** `_shared.tsv`，185 條翻譯涵蓋 1,425 個 key。
   **剩 237 條是各區塊自己的敘述文字**（已翻完：石英城 `game1:2/3/4/6`、
   ...
   維加斯 `game2:40/25/39`、黑桃賭場 `game2:41`、守護者堡壘 `game2:35/36`、
   野人村 `game1:49`、農業中心 `game1:9`、石英城街道 `game1:1`、
   沉睡者基地 `game2:15`、針岩城荒廢街 `game1:32`／舊彈藥庫 `game1:31`、
   達爾文基地 `game2:22`、維加斯街道 `game2:12`／廢棄街區 `game2:11`／
   下水道 `game2:24`、科奇斯基地內部 `game2:17`／生產線 `game2:19`、
   守護者堡壘內殿 `game2:42`、石英城廢棄街區 `game1:5`、
   血之神殿血池 `game1:28`），
   最大的幾塊是 `game1:43`（41）、`game2:18`（37）、`game2:7`（32）。
