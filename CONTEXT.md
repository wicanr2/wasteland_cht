...
**Remake 進度**：**二十四份規格全部 READY 並實作完成**（資產、亂數、畫面與文字、移動與時鐘、
角色與存檔、戰鬥、世界事件、設施、中文排版、翻譯管線、回合結構、遭遇生成、戰鬥指令、
遭遇掃描、戰鬥畫面、指令處理程式、設施互動迴圈、段落手札、輸入層、音效、遭遇迴圈、回合結算、設施場景），
`cmd/wasteland -mode play` 已經可以從出廠存檔開始走地圖、遇敵進戰鬥、**把戰鬥打完**、存檔。
