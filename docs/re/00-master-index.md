...
| `+0x80`–`+0xBB` | 30 × 2 | 陣列 A | 已確認（結構） |
| `+0xBD`–`+0xF8` | 30 × 2 | 陣列 B | 已確認（結構） |

**陣列 A／B 哪個是物品、哪個是技能尚未分辨。**
...
完整索引在 [`00-function-index.md`](00-function-index.md)（641 個，已分析 152）。
