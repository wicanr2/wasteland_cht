...
| `0x19F12` | 1 | **沖出目前這一行**：斷字 → 寫 scrollback（`seg003:0x8CE0`，40 × 256 環形）→ 送畫面 → 續行 | [`59`](59-playtest-against-original.md) | 玩家路徑對原版驗收：`cmd/wl-play`、輻射帶團滅是原版行為、Rad suit（物品 41）免疫 |
