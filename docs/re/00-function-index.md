...
| `0x1786E` | seg000+0x786E | 46 | 28 | re/03-boot-and-asset-loading.md、re/06-resource-directory.md |
| `0x1789C` | seg000+0x789C | 4 | 12 | re/06-resource-directory.md |
...
| `0x1001B` | seg000+0x1B | 3 | 10 | re/04-overlay-wla-bin.md |
...
| `0x18801` | seg000+0x8801 | 89 | 4 | re/10-huffman-compression.md |
| `0x1000F` | seg000+0xF | 3 | 3 | re/04-overlay-wla-bin.md |
...
| `0x1060C` | seg000+0x60C | 189 | 1 | re/04-overlay-wla-bin.md |
...
| `0x10CB6` | seg000+0xCB6 | 151 | 1 | re/04-overlay-wla-bin.md |
...
| `0x18744` | seg000+0x8744 | 189 | 1 | re/05-storage-layer.md、re/07-msq-blocks.md、re/09-msq-map-structure.md、re/10-huffman-compression.md |
