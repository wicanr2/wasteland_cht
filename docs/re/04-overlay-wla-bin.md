...
| 1 | `0x10003` | `0x10088` | 1 | 未解 |
| 2 | `0x10006` | `0x10144` | 1 | 未解 |
| 3 | `0x10009` | `0x10156` | 1 | 未解 |
| 4 | `0x1000C` | `0x1029B` | 4 | 未解（881 bytes，overlay 內最大） |
...
1. 逐一解 overlay 的其餘 21 個 slot，特別是 `0x1029B`（881 bytes，最大）。
